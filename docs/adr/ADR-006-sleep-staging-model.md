...
## Consequences
The LSTM upgrade is planned once 30+ nights of data are available. Realistic accuracy expectation for Random Forest on my own CSI data: 63-70% on sleep staging. This is an honest limitation documented in the README.
